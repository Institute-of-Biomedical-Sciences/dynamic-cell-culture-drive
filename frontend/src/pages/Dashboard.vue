<template>
  <div class="dashboard flex flex-col h-full ">
    ...
    <div class="grid h-full flex-grow">
      <div class="h-full col-4">
        <Card style="height: 81.5vh;">
...
<div class="flex flex-col items-center">
  <img src="@/assets/images/tilt-motor.gif" alt="Tilt Motor" class="w-full max-w-[230px] h-[200px] object-contain rounded" />
...
<div class="flex flex-col items-center">
  <img src="@/assets/images/rotary-motor.gif" alt="Rotary Motor" class="w-full max-w-[230px] h-[200px] object-contain rounded" />
...
<div class="flex flex-col items-center">
    <img src="@/assets/images/peristaltic-motor.gif" alt="Peristaltic Motor" class="w-full max-w-[230px] h-[200px] object-contain rounded" />
